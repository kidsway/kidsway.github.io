...
*Внимание: все ниже перечисленные инструкции носят ознакомительный характер и не являются обязательной инструкцией к исполнению.*
...
Зайдите в «Настройки» - «Power Manager» - «Mobile Manager» - «Настройки» - «Параметры экономии заряда батареи» - «Автозапуск Nanager» - «**KidsWay Staff**» - снимите флажок.
...
- Затем откройте настройки *Контроль фоновой активности* > **KidsWay Staff** > *Нет ограничений*
...
*Безопасность > Батарея > Режим Энергосбережения > **KidsWay Staff** > Нет ограничений*


#### Закрепление приложения
Чтобы настроить фоновую работу **KidsWay Staff** для устройств Xiaomi, обратите внимание на Батарею и права дос.

- Нажмите на кнопку *«Недавние задачи»* проведите вниз, **KidsWay Staff**, чтобы сделать опции *видимыми*
- Нажмите на иконку *замка*. Это не даст Xiaomi автоматически закрывать **KidsWay Staff**.
- Перейдите в раздел *Батарея*
- Выберите *Battery saver»* 
- Найдите и выберите **KidsWay Staff**
- Настройте следующие *Фоновые параметры*:
- Перейдите в *Разрешения*
- Выберите *Автозапуск*
- Убедитесь, что эта функция включена для **KidsWay Staff**
...
- Нажмите кнопку вызова фоновых приложений, коснитесь значка дополнительных настроек.
...
- Отправляйтесь в *"Приложения"* в основных настройках и выберите **KidsWay Staff** > затем *"Батарея"* > активируйте опции *"Сообщать об энергоемкости"* и *"Работа при выключенном экране"*;
- Затем в разделе *"Приложения"* откройте *"Настройки"* (внизу экрана) > *"Специальный доступ"* > выберите *"Игнорировать оптимизацию батареи"* > нажмите *"Разрешено"* > *"Все приложения"* > найдите **KidsWay Staff** в списке и выберите *"Запретить"*.
...
Подход к ограничениям фонового процесса у Meizu практически такой же, как и у двух предыдущих устройств — Huawei и Xiaomi. Чтобы избежать отключения фоновой работы **KidsWay Staff** и любого другого приложения, настройте следующие параметры:
...
- Выберите *"Защищенные приложения"* в разделе *"Менеджер батареи"* и проверьте, защищено ли ваше приложение;
- Откройте раздел *"Приложения"* и выберите **KidsWay Staff** > затем *"Батарея"* > активируйте опции *"Сообщать об энергоемкости"* и *"Работа при выключенном экране"*.
...
Перейдите в "Центр безопасности" - нажмите "Разрешения на конфиденциальность" - "Менеджер запуска" и дайте приложению **KidsWay Staff** разрешение работать в фоновом режиме.
...
 
- Найдите приложение **KidsWay Staff**
 
- Нажмите на него и выберите опцию *«Не оптимизировать»*
 
- Нажмите «Готово», чтобы сохранить изменения
 
- Нажмите на кнопку вызова фоновых приложений, затем зафиксируйте приложение **KidsWay Staff** нажав на значок *"замочка"*
...
- Откройте настройки устройства > *"Батарея"* > *"Оптимизация батареи"* > откройте список *"Все приложения"* (верхнее меню) >  **KidsWay Staff** > активируйте функцию *"Не оптимизировать"*.
...
Перейдите в Настройки - Батарея - Три точки справа вверху - Оптимизация батареи - Приложения - **KidsWay Staff** - отключите оптимизацию батареи.
...
- Нажмите на значок шестеренки в правом верхнем углу - Белый список фоновых приложений - Выберите **KidsWay Staff**
...
Android на заводской прошивке как правило не конфликтует с фоновыми процессами, но если вы все же столкнулись с проблемой фоновой работы, то необходимо включить режим «Всегда в VPN».
 ...
 - Откройте режим VPN и выберите **KidsWay Staff**
